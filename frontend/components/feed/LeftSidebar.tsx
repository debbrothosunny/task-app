    ...
    return (
        <div className="col-xl-3 col-lg-3 col-md-12 col-sm-12">
            <div className="_layout_left_sidebar_wrap">
                    ...
                    <div className="_left_inner_area_explore _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
                        ...
                        <ul className="_left_inner_area_explore_list">
                            <li className="_left_inner_area_explore_item _explore_item">
                                <Link href="/learning" className="_left_inner_area_explore_link">
                            ...
                            <li className="_left_inner_area_explore_item _explore_item">
                                <Link href="/gaming" className="_left_inner_area_explore_link">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
                            ...
                            <li className="_left_inner_area_explore_item">
                                <Link href="/save-post" className="_left_inner_area_explore_link">
                    ...
                    <div className="_left_inner_area_suggest _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
                        <div className="_left_inner_area_suggest_content _mar_b24">
                            ...
                            <span className="_left_inner_area_suggest_content_txt">
                                <Link className="_left_inner_area_suggest_content_txt_link" href="/suggested-people">See All</Link>
                            </span>
                        </div>
                        ...
                        <div className="_left_inner_area_suggest_info">
                            <div className="_left_inner_area_suggest_info_box">
                                <div className="_left_inner_area_suggest_info_image">
                                    <Link href="/profile/ryan-roslansky">
                ...
                {/* Events Section - FIXED: No nested anchors */}
                <div className="_layout_left_sidebar_inner">
                    <div className="_left_inner_area_event _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
                        ...
                        <div className="_left_inner_event_card">
                            <Link className="_left_inner_event_card_link" href="/event-single/1">
                            ...
                            <div className="_left_inner_event_bottom">
                                ...
                                <button className="_left_iner_event_bottom_link_btn">Going</button>
                            </div>
                        </div>

                        {/* Event 2 */}
                        <div className="_left_inner_event_card">
                            <Link className="_left_inner_event_card_link" href="/event-single/2">
                                <div className="_left_inner_event_card_iamge">
                                    <img src="assets/images/feed_event1.png" alt="Image" className="_card_img" />
                                </div>
                                <div className="_left_inner_event_card_content">
                                    <div className="_left_inner_card_date">
                                        <p className="_left_inner_card_date_para">15</p>
                                        <p className="_left_inner_card_date_para1">Aug</p>
                                    </div>
                                    <div className="_left_inner_card_txt">
                                        <h4 className="_left_inner_event_card_title">Summer Music Festival 2024</h4>
                                    </div>
                                </div>
                                <hr className="_underline" />
                            </Link>
                            <div className="_left_inner_event_bottom">
                                <p className="_left_iner_event_bottom">42 People Going</p>
                                <button className="_left_iner_event_bottom_link_btn">Going</button>
                            </div>
                        </div>
                    </div>
