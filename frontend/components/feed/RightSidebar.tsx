                        ...
                        <div className="_right_inner_area_info_ppl">
                            <div className="_right_inner_area_info_box">
                                <div className="_right_inner_area_info_box_image">
                                    <Link href="/profile/radovan-skillarena">
                                ...
                                <div className="_feed_right_inner_area_card_ppl_box">
                                    <div className="_feed_right_inner_area_card_ppl_image">
                                        <Link href="/profile/steve-jobs">
                                            <img src="/assets/images/people1.png" alt="Steve Jobs" className="_box_ppl_img" />
                                        </Link>
                                    </div>
                                ...
                                <div className="_feed_right_inner_area_card_ppl_box">
                                    <div className="_feed_right_inner_area_card_ppl_image">
                                        <Link href="/profile/ryan-roslansky">
                                            <img src="/assets/images/people2.png" alt="Ryan Roslansky" className="_box_ppl_img" />
                                        </Link>
                                    </div>
                                    <div className="_feed_right_inner_area_card_ppl_txt">
                                        <Link href="/profile/ryan-roslansky">
                                ...
                                <div className="_feed_right_inner_area_card_ppl_box">
                                    <div className="_feed_right_inner_area_card_ppl_image">
                                        <Link href="/profile/dylan-field">
                                            <img src="/assets/images/people3.png" alt="Dylan Field" className="_box_ppl_img" />
                                        </Link>
                                    </div>
                                    <div className="_feed_right_inner_area_card_ppl_txt">
                                        <Link href="/profile/dylan-field">
